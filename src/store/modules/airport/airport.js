import Aircraft from "@/api/aircraft/aircraft";
import Airport from "@/api/airport/airport"; //////
import airports from "@/router/routes/airports";
  ...
  actions: {
    ...
    items({commit}, payload) {
        return new Promise((resolve, reject) => {
            ...
            airport.list(payload.query).then(response => {
