...
import EngineType from "@/api/lookups/engine_type"
 const engine_type= new EngineType();

const EngineTypeModule = {
  namespaced: true,
  state: {
    auth: null,
    item: null,
  ...
  actions: {
    ...
    items({commit}, payload) {
        return new Promise((resolve, reject) => {
            ...
            engine_type.list(payload.query).then(response => {
...
export default EngineTypeModule;
