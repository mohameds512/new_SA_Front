...
import FleetType from "@/api/lookups/fleet_type"
const fleet_type= new FleetType();

const FleetTypeModule = {
 namespaced: true,
 state: {
   auth: null,
   item: null,
 ...
 actions: {
   ...
   items({commit}, payload) {
       return new Promise((resolve, reject) => {
           ...
           fleet_type.list(payload.query).then(response => {
...
export default FleetTypeModule;
