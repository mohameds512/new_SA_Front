<template>
    <div class="main_ecb_wrapper">
        ...
        <b-row v-if="$store.getters['pgc_forms/showSub']">
            <b-col>
                <div align="right">
                    <b-row class="bg-white pt-2 pb-2">
                        <div class="container">
                            ...
                            <b-col cols="12">
                                                        ...
                                                        <b-form-group class="text-right" label="رقم المنطقة ">
                                                            <validation-provider #default="{ errors }" name="رقم المنطقة "
                                                                ...
                                                                <v-select
                                                                        ...
                                                                        :options="Array.from(zones , (el) => el)"
                                                        ...
                                                        <b-form-group class="text-right" label="رقم اللوحة ">
                                                            <validation-provider #default="{ errors }" name="رقم اللوحة "
                                                                ...
                                                                <v-select
                                                                        ...
                                                                        :options="Array.from(all_plad_num.filter((element)=>element.area_num == form.submission.zone) , (el) => el.plad)"
                                ...
                                <!-- بيانات المالك  -->
                                <b-overlay v-if="(show_model_inputs == 2)" variant="white" spinner-variant="primary"
                                           blur="0" opacity=".75"
                                           rounded="sm">
                                    <div class="add_project_details_wrapper">
                                        <validation-observer ref="addProjectRules">
                                        ...
                                        <validation-observer ref="addProjectRules">
                                            <b-form v-if="this.hide == true">
                                                <b-row class="bg-white pt-2 pb-2">
                                                    ...
                                                    <b-col md="6">
                                                        <b-form-group class="text-right" label="الحد الشمالي">
                                                            <validation-provider #default="{ errors }"
                                                                                 name="الحد الشمالي"
                                                                                 rules="required">
                                                                <b-form-input
                                                    ...
                                                    <b-col md="6">
                                                        <b-form-group class="text-right" label="الحد الجنوبي">
                                                            <validation-provider #default="{ errors }"
                                                                                 name="الحد الجنوبي"
                                                                                 rules="required">
                                                                <b-form-input
                                                    ...
                                                    <b-col md="6">
                                                        <b-form-group class="text-right" label="الحد الشرقي">
                                                            <validation-provider #default="{ errors }"
                                                                                 name="الحد الشرقي"
                                                                                 rules="required">
                                                                <b-form-input
                                                    ...
                                                    <b-col md="6">
                                                        <b-form-group class="text-right" label="الحد الغربي">
                                                            <validation-provider #default="{ errors }"
                                                                                 name="الحد الغربي"
                                                                                 rules="required">
                                                                <b-form-input
                                        ...
                                        <validation-observer ref="addProjectRules">
                                            <b-form v-if="this.hide == true">
                                                <b-row class="bg-white pt-2 pb-2">
                                                    ...
                                                    <b-col md="4">
                                                        <b-form-group class="text-right" label=" رقم القطعة ">
                                                            <validation-provider #default="{ errors }" name="وصف رقم القطعة"
                                                                rules="required">
                                    ...
                                    <div class="add_project_details_wrapper">
                                        <validation-observer ref="addProjectRules">
                                            <b-form v-if="this.hide == true">
                                                <b-row class="bg-white pt-2 pb-2">
                                                    <b-col md="12" class="back_ground">
                                                        <p class="text-center">الحدود والأطوال بموجب أعمال الحصر
                                                            الميداني</p>
                                                    </b-col>
                                                    ...
                                                    <b-col md="2">
                                                        <b-form-group class="text-right"
                                                            ...
                                                            <validation-provider #default="{ errors }" name="ملاحظات "
                                                                                 rules="required">
                                                                <b-form-input v-model="includesForm.notes"
                                                                              :state="errors.length > 0 ? false : null"
                                                                              placeholder="ملاحظات " />
                                                                <!-- <small class="text-danger" v-if="errors[0]">هذا الحقل
                                                                    مطلوب</small> -->
                                                ...
                                                <div>
                                                    ...
                                                    <b-modal hide-header-close v-model="model_inc_edit"
                                                        ...
                                                        <div class="mt-2">
                                                            <b-col cols="12">
                                                                <div class="d-flex justify-content-end">
                                                                    <b-button @click="editIncludes()" variant="primary"
                                                                              style="margin-right: 10px;">تأكيد
                                                                    </b-button>
                                                                    <b-button @click="model_inc_edit = false"
                                                                              variant="outline-primary">الغاء
                                                                    </b-button>
                                                                </div>
                                                            </b-col>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.initGetIncs();
            this.$store.dispatch('pgc_forms/show_submission', this.$route.params.id)
                .then((res) => {
        ...
        methods: {
            returnContDate(){
                if(this.form.submission.contract_date){
                    ...
                    this.hYearV = the_date.split('/')[2].split(' ')[0];
                    this.hMonthV = the_date.split('/')[1];
                    this.hDayV = the_date.split('/')[0];
                }
            },
            getHijriDate(){
            ...
            initGetIncs() {
                this.$store.dispatch('dashboard/get_incs', this.$route.params.id)
                    .then((res) => {
            ...
            editIncludes() {
                ...
                dataInclude.append('image', this.editInc.image);
                dataInclude.append('build_id', this.editInc.build_id);
                dataInclude.append('build_desc_id', this.editInc.build_desc_id);
                dataInclude.append('qty', this.editInc.qty);
            ...
            addfloor() {
                this.sub_floors.push({roof: null, area: null});
            },
            floorFormLenght() {
                var x = this.sub_floors;
                return x.length;
            },
            ownersFormLenght() {
            ...
            checkSubmit($state) {
                ...
                this.$store.dispatch('pgc_forms/save_subs', {
                    ...
                    if ($state == 6 || $state == 10) {
                        ...
                        this.$router.push(`/viewRealty/${this.$route.params.id}`)
                    }
