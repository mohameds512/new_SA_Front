                                                ...
                                                <validation-observer ref="addProjectRules">
                                                    <b-form v-if="this.hide == true">
                                                        <b-row class="bg-white pt-2 pb-2">
                                                            ...
                                                            <b-col md="6">
                                                                <b-form-group class="text-left" label="حد الشمال">
                                                                    <validation-provider #default="{ errors }"
                                                                                         name="حد الشمال"
                                                                                         rules="required">
                                                                        <b-form-input
                                                                                ...
                                                                                :state="errors.length > 0 ? false : null"
                                                                                placeholder="حد الشمال" disabled/>
                                                                        <small class="text-danger" v-if="errors[0]">هذا
                                                                            الحقل
                                                                            مطلوب</small>
                                                                    </validation-provider>
                                                            ...
                                                            <b-col md="6">
                                                                <b-form-group class="text-left" label="حد الجنوب">
                                                                    <validation-provider #default="{ errors }"
                                                                                         name="حد الجنوب"
                                                                                         rules="required">
                                                                        <b-form-input
                                                            ...
                                                            <b-col md="6">
                                                                <b-form-group class="text-left" label="حد الشرق">
                                                                    <validation-provider #default="{ errors }"
                                                                                         name="حد الشرق"
                                                                                         rules="required">
                                                                        <b-form-input
                                                            ...
                                                            <b-col md="6">
                                                                <b-form-group class="text-left" label="حد الغرب">
                                                                    <validation-provider #default="{ errors }"
                                                                                         name="حد الغرب"
                                                                                         rules="required">
                                                                        <b-form-input
                                                                ...
                                                                <b-form-group class="text-left" label="حد الجنوب">
                                                                    <validation-provider #default="{ errors }"
                                                                        ...
                                                                        <b-form-input
                                                                                ...
                                                                                :state="errors.length > 0 ? false : null"
                                                                                placeholder="حد الجنوب" disabled/>
                                                                        <small class="text-danger" v-if="errors[0]">هذا
                                                                            الحقل
                                                                            مطلوب</small>
                                                                    </validation-provider>
