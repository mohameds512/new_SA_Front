  ...
  export default {
    ...
    computed: {
      ...mapGetters({
        lookups: "app/lookups",
        user: "users/item",
        engine_physical_class:"engine_physical_class/item",
        load: "users/load",
      }),
      id() {
    ...
    methods: {
      ...
      init() {
       ...
       console.log(this.id);
        ...
        if (this.id) {
             this.$store.dispatch('engine_physical_class/get', this.id).then(_ => {
          console.log('juiuniuniun')
            this.form = this.engine_physical_class;
      ...
      save() {
        ...
        this.$refs.simpleForm.validate().then((success) => {
           if (success) {
            this.$store
              .dispatch("engine_physical_class/put", { id: this.id, query: this.form })
              .then((_) => {
                this.$swal({
                  icon: "success",
