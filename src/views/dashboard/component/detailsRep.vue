      ...
      <section class="section_part_two">
        ...
        <div class="our_part_wrapper_e with_border_left with_border_bottom">
          <div class="p_one part with_border_left d-flex">
            <span class="name_s with_center_text with_border_left bg_main_color"
              >رقم الصك
            </span>
            <span>jdfj,</span>
          </div>
        ...
        <div class="our_part_wrapper_g with_border_left with_border_bottom">
          <div class="part_g_a with_border_left">
            ...
            <div class="gg_names_wrapper with_border_bottom">
              <span class="name bg_main_color with_center_text with_border_left"
                >الإسم</span
              >
              <span></span>
            </div>
        ...
        <div class="our_part_wrapper_c with_border_left with_border_bottom">
          <div class="title with_center_text with_border_bottom bg_main_colors">
        ...
        <div class="our_part_wrapper_d with_border_left with_center_text">
          <div class="part_d_one with_border_left">
            <div class="content_cont_c with_border_bottom">
              <span class="name with_border_left with_center_text bg_main_color"
                >الوظيفه</span
              >
              <span></span>
            </div>
            ...
            <div class="aside_one with_border_left">
              ...
              <div class="all_inputs with_border_bottom">
                <div class="inputs_one with_border_left">
                  <span class="input_number with_border_left">23</span>
                  <span class="input_number with_border_left">24</span>
                  <span class="input_number">25</span>
                </div>
                <div class="inputs_one a_b with_border_left">
                  <span class="input_number just_two_inputs with_border_left"
                    >23</span
                  >
                  <span class="input_number just_two_inputs">26</span>
                </div>
                <div class="inputs_one">
                  <span class="input_number just_two_inputs with_border_left"
                    >27</span
                  >
                  <span class="input_number just_two_inputs">28</span>
                </div>
              </div>
            </div>
            <div class="aside_one aside_two">
              ...
              <div class="all_inputs with_border_bottom">
                ...
                <div class="inputs_one second_two with_border_left">
                  <span class="input_number with_border_left">44</span>
                  <span class="input_number with_border_left">555</span>
                  <span class="input_number with_border_left">66</span>
                  <span class="input_number with_border_left">090</span>
                  <span class="input_number">02</span>
                </div>
              </div>
            </div>
          </div>
...
export default {
  ...
  mounted() {
    // console.log(this.id);
    // this.$store.dispatch("pgc_forms/show_sub", 55).then((res) => {
