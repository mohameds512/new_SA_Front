...
export default {
  ...
  mounted () {
    ...
    this.row = this.cell.parentNode.parentNode.parentNode
    this.thead = this.row.parentNode.parentNode
    //console.log("cell",this.cell.parentNode.parentNode.parentNode);
    this.colPos = Array.from(this.row.children).indexOf(this.cell.parentNode.parentNode) - 1
